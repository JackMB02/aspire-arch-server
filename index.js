...
app.use("/api/colleagues", theColleagueUniRoutes); // Alias for thecolleagueuni
    ...
    try {
        ...
        res.json({
            ...
            endpoints: {
                ...
                sustainable_practices:
                    "GET /api/research/sustainable-practices",
...
app.get("/api/home/health", async (req, res) => {
    try {
        ...
        const tables = ["items", "research_articles", "education_exhibitions"];
...
app.get("/api/newsevents/health", async (req, res) => {
    try {
        ...
        const tables = ["news_articles", "events"];
    ...
    try {
        ...
        app.listen(PORT, HOST, () => {
            ...
            if (process.env.NODE_ENV === "production") {
                ...
                console.log(
                    `🔗 Your app will be available at the Render public URL`
                );
            } else {
            ...
            console.log(
                `   🏛️ Architecture Colleagues Lab: /api/thecolleagueuni`
            );
