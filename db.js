...
const pool = new Pool({
    connectionString:
        ...
        "postgresql://neondb_owner:npg_SLMpTuH64wFc@ep-young-haze-ad2xjvz6-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require",
    ssl: {
...
async function initDb() {
    ...
    try {
        ...
        `);
                ...
                console.log(
                    `⚠️  Could not migrate ${table}.${column} (table may not exist yet)`
                );
            }
        }
    ...
    `);
        console.log(
            "✅ Architecture colleagues contact table created/verified"
        );
    ...
    `);
        console.log(
            "✅ Architecture colleagues initiatives table created/verified"
        );
    ...
    `);
        console.log(
            "✅ Architecture colleagues mission table created/verified"
        );
...
async function insertDefaultData(client) {
    ...
    const defaultStories = [
        {
            ...
            story_content:
                "The sustainable design workshop completely changed how I approach projects. I've implemented eco-friendly practices that reduced energy costs by 40% for my clients.",
            category: "workshop",
            is_featured: true,
        },
        {
            ...
            story_content:
                "Through the mentorship program, I connected with an experienced architect who guided me through my licensure process. I'm now a project lead at my firm.",
            category: "mentorship",
            is_featured: true,
        },
        {
            ...
            story_content:
                "The connections I've made through membership have led to collaborative projects and friendships with architects from around the world.",
            category: "membership",
            is_featured: true,
        },
    ];
    ...
    const defaultPhotos = [
        {
            ...
            description:
                "Modern urban architecture showcasing sustainable design principles",
        ...
        },
        {
            ...
            description:
                "Architecture that seamlessly integrates with natural surroundings",
        ...
        },
        {
            ...
            description:
                "Preservation and modernization of cultural heritage sites",
    ...
    const defaultVideos = [
        {
            ...
            description:
                "Complete walkthrough of our latest architectural project",
    ...
    const defaultWorkshops = [
        {
            ...
            instructor_bio:
                "Expert in sustainable architecture with 15+ years of experience",
            price: 299.0,
            capacity: 30,
    ...
    const defaultColleaguesInitiatives = [
        {
            ...
            description:
                "Connecting architecture students with experienced professionals for guidance and career development",
            status: "planned",
        ...
        },
        {
            ...
            description:
                "Hands-on workshops where students work together on real-world architectural challenges",
            status: "planned",
        ...
        },
        {
            ...
            description:
                "Digital archive documenting and preserving Rwandan architectural traditions and innovations",
            status: "in_progress",
        ...
        },
        {
            ...
            description:
                "Practical projects where students design and build solutions for local communities",
            status: "planned",
    ...
    const defaultColleaguesValues = [
        ...
        },
        {
            title: "Accessibility",
            description:
                "Making high-quality architectural resources available to students and professionals at all stages.",
            display_order: 2,
        },
        {
            title: "Innovation",
            description:
                "Continuously evolving to incorporate the latest research in architecture and design thinking.",
            display_order: 3,
        },
        {
            title: "Community",
    ...
    const defaultDesignProjects = [
        {
            ...
            description:
                "This library design focuses on sustainability, using glass facades for natural light and open spaces for collaborative learning. It integrates green courtyards and modern interiors. The project demonstrates innovative approaches to educational architecture while maintaining environmental consciousness.",
            category: "academic",
            sector: "educational",
        ...
        },
        {
            ...
            description:
                "The student housing project prioritizes affordability while maximizing comfort. Modular units are prefabricated and arranged around shared courtyards to foster community living. This approach reduces construction time and costs while creating vibrant student communities.",
            category: "academic",
            sector: "residential",
        ...
        },
        {
            ...
            description:
                "The villa design merges minimalism with luxury, featuring an infinity pool, open floor plans, and natural stone facades that harmonize with the surrounding landscape. Every detail is carefully considered to create a seamless indoor-outdoor living experience.",
        ...
        },
        {
            ...
            description:
                "This office tower reimagines workplace design with flexible interiors, solar glass technology, and smart energy systems to minimize environmental impact. The design promotes collaboration while reducing the building's carbon footprint through innovative sustainable technologies.",
            category: "professional",
            sector: "commercial",
        ...
        },
        {
            ...
            description:
                "The park project transforms a neglected urban area into a thriving green hub with walking paths, cultural pavilions, and recreational spaces. This competition-winning design addresses urban decay while creating valuable community assets that promote social interaction and environmental awareness.",
        ...
        },
        {
            ...
            description:
                "The cultural pavilion combines traditional motifs with modern construction. It serves as an exhibition space and a landmark for cultural events. This award-winning design successfully bridges historical context with contemporary architectural expression.",
            category: "competition",
            sector: "cultural",
    ...
    const defaultNewsArticles = [
        {
            ...
            content:
                "ASPIRE Architecture has been awarded the prestigious Sustainable Design Award for our innovative Urban Green Park project. The award recognizes excellence in environmentally conscious design and community-focused architecture.",
            image_url: "/images/park.jpg",
            category: "news",
        ...
        },
        {
            ...
            content:
                "We're excited to announce that construction has officially commenced on the Modern Campus Library at Northwood University. This state-of-the-art facility will feature innovative glass façade and energy-efficient design.",
            image_url: "/images/library.jpg",
            category: "news",
            author: "James Wilson",
            date: "2023-04-28",
        ...
        },
        {
            ...
            excerpt:
                "Collaboration with leading university for sustainable design research",
            content:
                "ASPIRE Design Lab has entered into a strategic research partnership with the University of Sustainable Architecture to advance innovative approaches to climate-resilient building design.",
            image_url: "/images/office.jpg",
            category: "news",
        ...
        },
        {
            ...
            content:
                "Our recent community design workshop brought together residents, architects, and city planners to co-create solutions for neighborhood revitalization. The collaborative approach yielded innovative ideas for public spaces.",
            image_url: "/images/pome.jpg",
            category: "news",
    ...
    const defaultEvents = [
        {
            ...
            description:
                "Join leading architects and urban planners as we explore the future of sustainable urban living. This conference will feature keynote presentations, panel discussions, and networking opportunities focused on innovative approaches to urban development.",
        ...
        },
        {
            ...
            description:
                "Interactive workshop focused on creating public areas that foster community interaction. Learn design principles for inclusive, accessible, and engaging community spaces through hands-on activities and case studies.",
        ...
        },
        {
            ...
            description:
                "Experience sustainable architecture firsthand with our guided tour of award-winning eco-friendly projects. Visit buildings that demonstrate innovative approaches to energy efficiency, material selection, and environmental integration.",
            image_url: "/images/villa.jpg",
        ...
        },
        {
            ...
            excerpt:
                "Showcasing the beauty of modern architecture through photography",
            description:
                "An exhibition featuring stunning architectural photography that captures the essence of modern design. The event includes talks by renowned architectural photographers and opportunities to network with industry professionals.",
            image_url: "/images/pavilion.jpg",
...
async function query(text, params) {
    ...
    while (retries > 0) {
        try {
            ...
            console.error(
                "Database query error (attempt " + (3 - retries) + "):",
                error
            );
